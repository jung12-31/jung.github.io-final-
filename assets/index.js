...
function initAllFunctions() {
    ...
    updateWishlistCount();   // 初始化喜好清單計數顯示
    updateFollowButtons();   // 初始化追蹤按鈕狀態
    ...
    if (productId) {
        setTimeout(() => {
            showProductDetailDirectly(parseInt(productId));
        }, 500);
    }
...
const categories = [
    {
        id: 1,
        name: "法式塔派",
        description: "酥脆塔皮搭配多種美味內餡",
        image: "./assets/images/front page/1.webp",
        link: "./Pages/pie/pie.html",
        subcategories: ["蘋果派", "櫻桃派", "樹莓派", "胡桃派", "檸檬蛋白派"]
    },
    {
        id: 2,
        name: "西式常溫甜點",
        description: "精緻法式與創意甜點",
        image: "./assets/images/front page/1.png",
        link: "./Pages/dessert/dessert.html",
        subcategories: ["司康", "可麗露", "瑪德蓮", "費南雪", "馬卡龍"]
    },
    {
        id: 3,
        name: "手工餅乾",
        description: "手工製作的美味餅乾",
        image: "./assets/images/front page/2.png",
        link: "./Pages/cookies/cookies.html",
        subcategories: ["巧克力餅乾", "曲奇餅乾", "燕麥餅乾", "美式軟餅乾"]
    },
    {
        id: 4,
        name: "歐式麵包",
        description: "天然酵母傳統工法製作",
        image: "./assets/images/front page/3.png",
        link: "./Pages/bread/bread.html",
        subcategories: ["雙起司軟歐麵包", "花生起司帕尼尼", "海鹽奶油卷", "蜂蜜生吐司"]
    },
    {
        id: 5,
        name: "泡芙",
        description: "外酥內滑的輕甜點心，一口享受的幸福滋味",
        image: "./assets/images/front page/4.png",
        link: "./Pages/puffs/puffs.html",
        subcategories: ["法式葡萄泡芙", "芒果泡芙", "提拉米蘇泡芙", "黑糖珍珠泡芙"]
    },
    {
        id: 6,
        name: "蛋糕專區",
        description: "精選多款人氣蛋糕，陪你度過每一個值得紀念的日子",
        image: "./assets/images/front page/5.png",
        link: "./Pages/cake/cake.html",
        subcategories: ["伯爵茶長條蛋糕", "蜂蜜蛋糕", "年輪蛋糕", "蜂蜜年輪蛋糕", "經典起司蛋糕", "可可伯爵薄餅", "咖啡巧克力松露蛋糕", "岩漿巧克力蛋糕"]
    }
];
...
function showUserProfile() {
    ...
    profilePopup.innerHTML = `
        ...
        <div class="profile-links">
            <a href="./Pages/safe/safe.html" class="profile-link">
...
// 添加商品到購物車
function addToCart(product, flavor = "原味") {
    ...
    updateCart();
    showNotification(`已將 ${product.name} (${flavor}) 加入購物車`, 'success');
}
...
function toggleWishlist(productId, productName, productPrice, productImage) {
    ...
    if (existingIndex !== -1) {
        ...
        if (followBtn) {
            ...
            followBtn.style.borderColor = 'rgba(79, 67, 54, 0.2)';
        }
        ...
        if (followBtn) {
            ...
            followBtn.style.borderColor = 'rgba(255, 71, 87, 0.3)';
        }
...
function updateFollowButtons() {
    ...
    followBtns.forEach(btn => {
        ...
        if (isTracked) {
            ...
            btn.style.borderColor = 'rgba(79, 67, 54, 0.2)';
        }
    });
}
    ...
    modal.innerHTML = `
        <div class="modal-content" style="max-width: 900px;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                ...
                <span class="close-modal" onclick="closeWishlist()" style="font-size: 1.8rem; cursor: pointer; padding: 0 10px;">&times;</span>
            </div>
            ...
            ${wishlist.length > 0 ? `
                <div style="margin-top: 25px; padding-top: 20px; border-top: 1px solid #eee; display: flex; justify-content: space-between; align-items: center;">
                    <div>
                        <button class="cta-btn" onclick="addAllToCart()" style="margin-right: 10px; padding: 8px 20px;">
                            <i class="fas fa-cart-plus"></i> 全部加入購物車
                        </button>
                        <button class="btn-remove-wishlist" onclick="clearWishlist()" style="padding: 8px 20px;">
            ...
            <div style="margin-top: 25px; text-align: center;">
                <button class="cta-btn" onclick="closeWishlist()" style="padding: 10px 40px;">
...
function initContactForm() {
    ...
    contactForm.addEventListener('submit', function(e) {
        e.preventDefault();
        showNotification('訊息已發送，我們會儘快回覆您！');
        this.reset();
    });
}
...
// 產品詳細功能（首頁用不到，但保留接口）
function showProductDetailDirectly(productId) {
    console.log('嘗試顯示產品詳細資訊:', productId);
    // 首頁不需要產品詳細頁面，所以留空
}
